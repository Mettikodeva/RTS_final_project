...
json_content='''
 {
  ...
  "parts": [
    ...
    { "type": "wokwi-ds1307", "id": "rtc1", "top": -208.61, "left": 92.58, "attrs": {} }
  ],
  "connections": [
    ...
    [ "oled1:VCC", "esp:VIN", "red", [ "v-45.2", "h-243.19", "v271.52" ] ],
    ...
    [ "rtc1:GND", "oled1:GND", "black", [ "h0" ] ],
    [ "rtc1:5V", "oled1:VCC", "red", [ "h-21.56", "v-24.57", "h142.46" ] ],
    [ "rtc1:SDA", "oled1:SDA", "magenta", [ "h-33", "v-45.51", "h172.21" ] ],
    [ "rtc1:SCL", "oled1:SCL", "cyan", [ "h-32.43", "v63.42", "h160.2" ] ]
  ],
...
os.rename('scripts/main_RTC.ino', 'src/main_RTC.ino')
...
[wokwi]
version = 1
firmware = '.pio\build\esp32dev_RTC_Clock\firmware.bin'
elf = '.pio\build\esp32dev_RTC_Clock\firmware.elf'
"""
